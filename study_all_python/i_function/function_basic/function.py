...
def input_str_count_search_char(str,char):
    return str.count(char)

print("hi123")
print(+input_str_count_search_char("appppppppppppppppppppppppppppppple","p"))
print("hi123")

def str_check_char_count(str,char):
    count = 0
    for i in str:
        if i == char:
            count += 1
...
print(str_check_char_count("apple","p"))

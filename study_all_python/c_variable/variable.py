...
formatting = "Hello {}, {} is fantastic"
print(formatting.format(leg_kr, leg_en))

formatting = "Hello {}, {} is fantastic".format(leg_kr,leg_en)
print(formatting)

leg_kr = "리액트"
leg_en = "React.js"
formatting = "Hello {0}, {1} is fantastic".format(leg_kr,leg_en)
print(formatting)

leg_kr = "장고"
leg_en = "Django"
formatting = "Hello {kr}, {en} is fantastic".format(kr = leg_kr, en = leg_en)
print(formatting)
